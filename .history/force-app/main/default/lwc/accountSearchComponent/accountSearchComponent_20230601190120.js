...
import getAccs from '@salesforce/apex/AccountSearchController.getAccounts';
...
export default class AccountSearchComponent extends LightningElement {
    ...
    handleSearch() {
        ...
        getAccs({state : this.state,city : this.city,industry : this.industry,rating : this.rating,name : this.name,phone : this.phoneNumber,offset :this.rowOffSet})
        .then(result => {
